...
export const migrateSchema = (client: Client) => async (event, _context) => {
    try {
        ...
        `);
        await client.query(`
            INSERT INTO products (title, description, price, logo, count) values
            ('Product 1','Product 1 description', 1000, 'https://r5.readrate.com/img/pictures/basic/792/792600/7926007/w800h317-76be96b9.jpg', 1),
